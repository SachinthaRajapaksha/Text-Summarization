...
def summarize_text(text, summary_type, method='combined'):
    ...
    if method == 'extractive':
        ...
        summary = summarizer(text, max_length=int(length/4), min_length=int(length/5))
        ...
        abstractive_summary = summarizer(combined_text, max_length=int(length/4), min_length=int(length/5))
